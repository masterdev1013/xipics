				...
				<Listbox value={height} onChange={value => setHeight(value)}>
					<div className="relative mt-1">
						...
						<Transition
							...
							leaveTo="opacity-0"
						>
							<Listbox.Options className="max-h-100 ring-dark/5 absolute z-10 mt-1 w-full overflow-auto rounded-md bg-gray-600 py-1 text-base shadow-lg ring-1 focus:outline-none sm:text-sm">
