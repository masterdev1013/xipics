...
interface PropsType {
	...
	closeModal: () => void;
	modelName: string;
	setModel_name: (_var: string) => void;
	isOpen: boolean;
		...
		<>
			...
			<div className="inset-0 items-center ">
				<button
					type="button"
					onClick={openModal}
					className="focus-visible:ring-primary/75 flex w-full items-center justify-between rounded-md border-2 border-input-boarder bg-transparent px-4 py-2 text-sm font-medium text-white focus:outline-none focus-visible:ring-2"
				>
